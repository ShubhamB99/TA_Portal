...
def perform_login(auth_code, redir, request):
    ...
    if (profile_json['type']=='ug' or profile_json['type']=='pg' or profile_json['type']=='dd') and (profile_json['roll_number']!="180070050" and profile_json['roll_number']!="18D070021" and profile_json['roll_number']!="180070060" and profile_json['roll_number']!="17D170016" and profile_json['roll_number']!="180100098" and profile_json['roll_number']!="180100002"):
        print("STUDENT")
        try:
